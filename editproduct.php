    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="form-group">
                    <label>Barcode</label>
                    <input type="text" class="form-control" placeholder="Enter Barcode" value="<?php echo $barcode_db;?>" name="txtbarcode" autocomplete="off" disabled >
        </div>

        <div class="form-group">
                    <label>Product Name</label>
                    <input type="text" class="form-control" placeholder="Enter name" value="<?php echo $product_db;?>"name="txtproductname" autocomplete="off">
        </div>
        ...
        ?>
        <option <?php if ($row['category']==$category_db) { ?> <?php } ?> 
        ...
        <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" placeholder="Enter Description" name="txtdescription" rows="4" require><?php echo $description_db;?> </textarea>
        </div>
        ...
        <div class="form-group">
                    ...
                    <input type="number" min="1" step="any" class="form-control" placeholder="Enter Stock" value="<?php echo $stock_db;?>"   name="txtstock" required>
        </div>

        <div class="form-group">
                    <label>Purchase Price</label>
                    <input type="number" min="1" step="any" class="form-control" placeholder="Enter Stock" value="<?php echo $purchaseprice_db;?>" name="txtpurchaseprice" required>
        </div>

        <div class="form-group">
                    <label>Sale Price</label>
                    <input type="number" min="1" step="any" class="form-control" placeholder="Enter Stock" value="<?php echo $saleprice_db;?>" name="txtsaleprice" required>
