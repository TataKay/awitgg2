          ...
          <div class="card-body">
              ...
              if (isset($_POST['btnedit'])) {
                ...
                <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" placeholder="Enter Categry" value="'.$row->catid.'" name="txtcatid" >


                      <input type="text" class="form-control" placeholder="Enter Categry" value="'.$row->category.'" name="txtcategory">
                ...
                <div class="form-group">
                      <label for="exampleInputEmail1">Category</label>
                      <input type="text" class="form-control" placeholder="Enter Categry" name="txtcategory">
                    </div>
              ...
              ?>
                  ...
                  <div class="col-md-8">
                  <table id="table_category"   class="table table-striped tbale-hover">
                  <thead>
                    <tr>
                      <td>#</td>
                      <td>Category</td>
